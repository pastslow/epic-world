...
export class Player {
   ...
   public static loadPlayer(this: Phaser.Scene): void {
      this.load.spritesheet('player', 'assets/Characters/GraveRobber/anim/player.png', { frameWidth: 48, frameHeight: 48 });
   }

   public static initializePlayer(this: Phaser.Scene, platforms: Phaser.Physics.Arcade.StaticGroup, buildingsGroup: Phaser.Physics.Arcade.Group): void {
      Player.entity = this.physics.add.sprite(1000, window.innerHeight - 100, 'player');
      ...
      this.physics.add.overlap(Player.entity, buildingsGroup, Player.playerHitBuilding, null, this);
   }

   public static listenToPlayerActions(this: Phaser.Scene, buildingsGroup: Phaser.Physics.Arcade.Group): void {
   ...
   public static listenToPlayerMovement(): void {
      ...
      if (GameCursors.keyboardControls.up.isDown && Player.entity.body.touching.down && !Player.preventJumping) {
         Player.entity.setVelocityY(-150);
      }
   }

   private static restrictPartialActionsInAreas(this: Phaser.Scene, buildingsGroup: Phaser.Physics.Arcade.Group): void {
